...
OutputDir=C:\Fontes\Whellpro\WheelPro\Instalador
OutputBaseFilename=setup_WheelPro_Remoto
SetupIconFile=C:\Fontes\Whellpro\WheelPro\Instalador\Icone.ico
Password=123456
Encryption=yes
Compression=lzma
...
Source: "C:\Fontes\Whellpro\WheelPro\Imagens\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
; NOTE: Don't use "Flags: ignoreversion" on any shared system files
Source: "Server.ini"; DestDir: "{app}"
Source: "midas.dll"; DestDir: "{app}"; Flags: 32bit
