...
CREATE TABLE `linha` (
  ...
  `datalterecao` datetime DEFAULT NULL,
...
INSERT INTO `linha` VALUES (1,1,'Jantes','S',NULL,NULL,NULL,1),(2,NULL,'Jantes',NULL,NULL,NULL,NULL,NULL);
...
-- Dump completed on 2024-01-08 17:31:56
